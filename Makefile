...
################################################
EVENTQ_OBJECT = Backend/event_queue/event_queque.o
...
menu_front.o: Frontend/Allegro/menu_front.c Frontend/Allegro/headall.h Backend/event_queue/event_queue.h
